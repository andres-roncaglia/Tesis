...
plot_forecast(data = atenciones_guardia, forecast = resultados_arima['pred_atenciones_2'], pred_color = '#6BC78A', line_color='black', label = 'ARIMA', long = 48, ylabel= 'Atenciones', legend_position = (0.3,0.98)).save("../Imgs/plotnine/arima1.png", width=6, height=4/2.7, dpi=700)

plot_forecast(data = atenciones_guardia, forecast = resultados_1_arima['pred'], pred_color = '#6BC78A', line_color='black', label = 'ARIMA', ylabel= 'Atenciones', legend_position = 'none', long = 48).save("../Imgs/plotnine/arima2.png", width=6, height=4/2.7, dpi=700)

plot_forecast(data = trabajadores, forecast = resultados_arima['pred_trabajadores_1'], line_color='black', pred_color = '#5299CB', label = 'ARIMA', long = 48, ylabel= 'Trabajadores (miles)', legend_position = (0.3,0.98)).save("../Imgs/plotnine/arima3.png", width=6, height=4/2.7, dpi=700)

plot_forecast(data = tiempo_rosario[['ds','y']], forecast = resultados_arima['pred_temperatura_3'], pred_color = '#E23C47', line_color='black', label = 'ARIMA', long = 48, xlabel='Día', ylabel= 'Atenciones', legend_position = 'none').save("../Imgs/plotnine/arima4.png", width=6, height=4/2.7, dpi=700)
...
|           Serie          |   $A$  |   $P$  |   $H$  | $\eta$ |   $C$  |    MAPE    | Interval Score |
|:------------------------:|:------:|:------:|:------:|:------:|:------:|:----------:|:--------------:|
...
plot_forecast(data = tiempo_rosario, forecast = resultados_3_xgb['pred'], pred_color = '#E44E58', line_color='black', label = 'XGBoost', long = 48, xlabel='Día', ylabel= 'Temperatura', legend_position='none'
...
plot_forecast(data = tiempo_rosario, forecast = resultados_3_lgbm['pred'], pred_color = '#E44E58', line_color='black', label = 'LightGBM', long = 48, xlabel='Día', ylabel= 'Temperatura', legend_position='none'
...
Cada 10 iteraciones se evalúa la función de perdida. Que la paciencia sea igual a 5 lleva a que si la función de pérdida no mejora en las últimas 5 evaluaciones se detenga el entrenamiento. A su vez, que el *dropout* sea 0.1 lleva a que cada neurona tenga una probabilidad de 0.1 de que se apague en cada iteración.
...
|           Serie          |   $N$  |   $C$  |   $D$  | $\eta$ |   $P$  |   $O$  |    MAPE    | _Interval Score_ |
|:------------------------:|:------:|:------:|:------:|:------:|:------:|:------:|:----------:|:----------------:|
|   Atenciones en guardia  | `{python} resultados_1_lstm['grilla'][resultados_1_lstm['grilla']['Seleccionado'] == True].head(1)['max_steps'].values[0]` | `{python} resultados_1_lstm['grilla'][resultados_1_lstm['grilla']['Seleccionado'] == True].head(1)['encoder_n_layers'].values[0]` | `{python} resultados_1_lstm['grilla'][resultados_1_lstm['grilla']['Seleccionado'] == True].head(1)['decoder_layers'].values[0]` | `{python} float(resultados_1_lstm['grilla'][resultados_1_lstm['grilla']['Seleccionado'] == True].head(1)['learning_rate'].values[0])` | `{python} float(resultados_1_lstm['grilla'][resultados_1_lstm['grilla']['Seleccionado'] == True].head(1)['early_stop_patience_steps'].values[0])` | `{python} float(resultados_1_lstm['grilla'][resultados_1_lstm['grilla']['Seleccionado'] == True].head(1)['encoder_dropout'].values[0])` | `{python} round(resultados_1_lstm['mape'], 4)` | `{python} round(resultados_1_lstm['score'], 4)` |
| Trabajadores registrados | `{python} resultados_2_lstm['grilla'][resultados_2_lstm['grilla']['Seleccionado'] == True].head(1)['max_steps'].values[0]` | `{python} resultados_2_lstm['grilla'][resultados_2_lstm['grilla']['Seleccionado'] == True].head(1)['encoder_n_layers'].values[0]` | `{python} resultados_2_lstm['grilla'][resultados_2_lstm['grilla']['Seleccionado'] == True].head(1)['decoder_layers'].values[0]` | `{python} float(resultados_2_lstm['grilla'][resultados_2_lstm['grilla']['Seleccionado'] == True].head(1)['learning_rate'].values[0])` | `{python} float(resultados_2_lstm['grilla'][resultados_2_lstm['grilla']['Seleccionado'] == True].head(1)['early_stop_patience_steps'].values[0])` | `{python} float(resultados_2_lstm['grilla'][resultados_2_lstm['grilla']['Seleccionado'] == True].head(1)['encoder_dropout'].values[0])` | `{python} round(resultados_2_lstm['mape'], 4)` | `{python} round(resultados_2_lstm['score'], 4)` |
|        Temperatura       | `{python} resultados_3_lstm['grilla'][resultados_3_lstm['grilla']['Seleccionado'] == True].head(1)['max_steps'].values[0]` | `{python} resultados_3_lstm['grilla'][resultados_3_lstm['grilla']['Seleccionado'] == True].head(1)['encoder_n_layers'].values[0]` | `{python} resultados_3_lstm['grilla'][resultados_3_lstm['grilla']['Seleccionado'] == True].head(1)['decoder_layers'].values[0]` | `{python} float(resultados_3_lstm['grilla'][resultados_3_lstm['grilla']['Seleccionado'] == True].head(1)['learning_rate'].values[0])` | `{python} float(resultados_3_lstm['grilla'][resultados_3_lstm['grilla']['Seleccionado'] == True].head(1)['early_stop_patience_steps'].values[0])` | `{python} float(resultados_3_lstm['grilla'][resultados_3_lstm['grilla']['Seleccionado'] == True].head(1)['encoder_dropout'].values[0])`  | `{python} round(resultados_3_lstm['mape'], 4)` | `{python} round(resultados_3_lstm['score'], 4)` |
...
plot_forecast(data = tiempo_rosario, forecast = resultados_3_lstm['pred'], pred_color = '#E44E58', line_color='black', label = 'LSTM', long = 48, xlabel='Día', ylabel= 'Temperatura', legend_position='none'
...
plot_forecast(data = tiempo_rosario, forecast = resultados_3_gpt['pred'], pred_color = '#E44E58', line_color='black', label = 'TimeGPT', long = 48, xlabel='Día', ylabel= 'Temperatura', legend_position='none'
...
plot_forecast(data = tiempo_rosario, forecast = resultados_3_chronos['pred'], pred_color = '#E44E58', line_color='black', label = 'Chronos', long = 48, xlabel='Día', ylabel= 'Temperatura', legend_position='none'
...
- finetuning en modelos fundacionales
...
- medir los tiempos de ejecucion como un todo?
