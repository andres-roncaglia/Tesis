...
```{python}
plt.plot(atenciones_guardia['ds'], atenciones_guardia['y'], color = "#292F36")
plt.xlabel('Fecha')
...
```{python}
plt.plot(trabajadores['ds'], trabajadores['y'], color = "#4D533C")
plt.xlabel('Fecha')
...
plt.plot(tiempo_rosario['ds'], tiempo_rosario['y'], color = "#520004")
...
plt.plot(tiempo_rosario['ds'], tiempo_rosario['HUM'], color = "#520004")
plt.xlabel('')
plt.ylabel('Humedad (%)')
plt.tick_params(labelbottom=False)
...
plt.plot(tiempo_rosario['ds'], tiempo_rosario['PNM'], color = "#520004")
plt.xlabel('Fecha')
