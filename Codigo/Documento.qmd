...
foto del descenso del gradiente
...
Donde $Old_{t-1}$ es la información guardada actualmente y $Old_t$ la información que se mantendrá para la próxima iteración de la red.
...
TimeGPT es un modelo transformer preentrenado (de aquí las siglas GPT, *generative pre-trained transformer*) para el pronóstico de series de tiempo que puede producir predicciones en diversas áreas y aplicaciones con gran precisión y sin entrenamiento adicional. Los modelos preentrenados constituyen una gran innovación, lo que mejora la accesibilidad, precisión, eficiencia computacional y velocidad del pronóstico.

TimeGPT es un modelo fundacional, con mecanismos de autoatención, que no es de código abierto. La autoatención captura dependencias y relaciones en la secuencias de valores que se alimentan al modelo, logrando poner en contexto a cada observación. 
...
- Series a utilizar: 
      ...
      variable exogena > Temperatura + Lluvia?
      
- Orden: 
      Redes neuronales
      LSTM
      Modelos transformer y fundacionales
      Chronos
      Revisar TimeGPT
      Revisar Arima
