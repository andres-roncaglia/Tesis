...
Se *tokenizan* los datos de entrada y se los representa vectorialmente ($\vec E$). Se suma a $\vec E$ un vector con patrones específicos que integran al vector de entrada la información posicional del *token*.
:::
...
| Estructura *transformer*          | Especializado en series de tiempo | Adaptación de modelos de lenguaje |
...
No realizan supuestos distribucionales, y por lo tanto, no generan pronósticos probabilísticos.
...
Temperaturas por hora en los primeros días de marzo de 2025 en la ciudad de Rosario
:::

:::

## 4.1 Aplicación: SARIMA - Serie 1 {.theme-slideSimple auto-animate="true"}
...
## 4.1 Aplicación: SARIMA - Serie 1 {.theme-slideSimple}
...
## 4.1 Aplicación: SARIMA - Serie 2 {.theme-slideSimple}
...
:::{.centro}
Modelo seleccionado de forma automática con `autoarima`: $SARIMAX(1,1,1)(2,0,1)_{24}$
:::
...
- $P$: Profundidad máxima de cada árbol

- $H$: Número máximo de hojas de cada árbol
...
- $C$: Proporción de características utilizadas
...
- $D$: Proporción de *dropout* en cada capa
